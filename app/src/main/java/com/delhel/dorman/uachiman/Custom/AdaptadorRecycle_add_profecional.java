 ...
 */
public class AdaptadorRecycle_add_profecional extends RecyclerView.Adapter<AdaptadorRecycle_add_profecional.Holder> {

    List<Modelo_Profesionales> listado;
    Context context;


    public AdaptadorRecycle_add_profecional(List<Modelo_Profesionales> listado, Context context) {
